...
public class Domain {
    ...
    // Cloudflare SaaS details (New Architecture)
    private String cloudflareHostnameId;
    private String cloudflareStatus; // pending_validation, active, etc.
    private boolean cloudflareBranding;

    // SSL details (TXT is Canonical)
    private String sslValidationMethod = "TXT"; // Default to TXT
    private String sslTxtName; // _acme-challenge.example.com
    private String sslTxtValue; // [token]
    private String sslCnameTarget; // [uuid].dcv.cloudflare.com (Optional Accelerator)
    ...
    public void addOwnershipHistory(String fromOwnerType, String fromOwnerId, String reason) {
        ownershipHistory
                .add(new OwnershipHistory(fromOwnerType, fromOwnerId, ownerType, ownerId, reason, LocalDateTime.now()));
    }
    ...
    // Cloudflare SaaS Getters/Setters
    ...
    public boolean isCloudflareBranding() {
    ...
    public String getSslValidationMethod() {
        return sslValidationMethod;
    }

    public void setSslValidationMethod(String sslValidationMethod) {
        this.sslValidationMethod = sslValidationMethod;
    }

    public String getSslTxtName() {
        return sslTxtName;
    }

    public void setSslTxtName(String sslTxtName) {
        this.sslTxtName = sslTxtName;
    }

    public String getSslTxtValue() {
        return sslTxtValue;
    }

    public void setSslTxtValue(String sslTxtValue) {
        this.sslTxtValue = sslTxtValue;
    }

    public String getSslCnameTarget() {
        return sslCnameTarget;
    }

    public void setSslCnameTarget(String sslCnameTarget) {
        this.sslCnameTarget = sslCnameTarget;
    }
    ...
    public LocalDateTime getLastReconfirmation() {
        return lastReconfirmation;
    }

    public void setLastReconfirmation(LocalDateTime lastReconfirmation) {
        this.lastReconfirmation = lastReconfirmation;
    }

    public LocalDateTime getNextReconfirmationDue() {
        return nextReconfirmationDue;
    }

    public void setNextReconfirmationDue(LocalDateTime nextReconfirmationDue) {
        this.nextReconfirmationDue = nextReconfirmationDue;
    }
    ...
    public void setTotalRedirects(long totalRedirects) {
    ...
    public static class OwnershipHistory {
        ...
        public OwnershipHistory(String fromOwnerType, String fromOwnerId, String toOwnerType, String toOwnerId,
                String reason, LocalDateTime transferredAt) {
