...
public interface UserRepository extends MongoRepository<User, String> {
       ...
       // Find agency by custom domain (White-Label UI)
       Optional<User> findByAgencyCustomDomain(String agencyCustomDomain);
       ...
       org.springframework.data.domain.Page<User> findUsersWithFilters(
                     String status, String plan, String dateFrom, String dateTo,
                     org.springframework.data.domain.Pageable pageable);
}