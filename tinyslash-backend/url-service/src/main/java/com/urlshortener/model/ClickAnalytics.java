...
@CompoundIndexes({
        @CompoundIndex(name = "user_campaign_idx", def = "{'userId': 1, 'utmCampaign': 1}"),
        @CompoundIndex(name = "user_clickedat_idx", def = "{'userId': 1, 'clickedAt': -1}")
})
public class ClickAnalytics {
    ...
    public boolean isUniqueClick() {
        return isUniqueClick;
    }

    public void setUniqueClick(boolean uniqueClick) {
        isUniqueClick = uniqueClick;
    }
