...
public interface ShortenedUrlRepository extends MongoRepository<ShortenedUrl, String> {
    ...
    // Find by numeric ID (Feistel Engine)
    Optional<ShortenedUrl> findByNumericId(Long numericId);
    ...
    List<ShortenedUrl> findByScopeTypeAndScopeIdAndCreatedAtBetween(String scopeType, String scopeId,
